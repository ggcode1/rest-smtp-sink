...
RestSmtpSink.prototype.createWebServer = function() {
  ...
  app.get(
    ...
    asyncHandler(async (req, res, next) => {
      ...
      res.write(
        "<table><thead><tr><td>ID<td>Del<td>Purge<td>To<td>From<td>Subject<td>Date</thead><tbody>"
      );
      ...
      function render_item(item) {
        return (
          '<tr><td><a href="/api/email/' +
          _.escape(item.id) +
          '">' +
          _.escape(item.id) +
          "</a>" +
          '<td><a href="/api/email/delete/' +
          _.escape(item.id) +
          '"> Del </a>' +
          '<td><a href="/api/email/purge/' +
          _.escape(item.id) +
          '"> Purge </a>' +
          "<td>" +
          _.escape(item.to) +
          ...
          _.escape(item.from) +
          "<td>" +
          _.escape(item.subject) +
          "<td>" +
          _.escape(new Date(item.created_at))
        );
      }
